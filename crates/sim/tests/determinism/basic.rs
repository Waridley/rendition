...
fn basic_single_tick() {
	...
	app1
		.add_systems(Update, run_sim_schedule)
		.world_mut()
		.spawn((RigidBody::Dynamic, Collider::sphere(0.5), Transform::default()));
	app1.update();
...
fn drop_sphere_exactly_above_sphere() {
	...
	let world = app1
		.add_systems(Update, run_sim_schedule)
		.world_mut();
	let s1 = world.spawn((RigidBody::Static, Collider::sphere(0.5), Transform::default())).id();
	let d1 = world.spawn((RigidBody::Dynamic, Collider::sphere(0.5), Transform::from_xyz(0.0, 0.0, 10.0))).id();
	for _ in 0..1000 {
		app1.update();
	}
	...
	let world = app2
		.add_systems(Update, run_sim_schedule)
		.world_mut();
	let s2 = world.spawn((RigidBody::Static, Collider::sphere(0.5), Transform::default())).id();
	let d2 = world.spawn((RigidBody::Dynamic, Collider::sphere(0.5), Transform::from_xyz(0.0, 0.0, 10.0))).id();
	for _ in 0..1000 {
		app2.update();
	}
...
fn drop_sphere_slightly_off_center() {
	...
	let world = app1
		.add_systems(Update, run_sim_schedule)
		.world_mut();
	world.spawn((RigidBody::Static, Collider::sphere(0.5), Transform::default()));
	let d1 = world.spawn((RigidBody::Dynamic, Collider::sphere(0.5), Transform::from_xyz(0.1, 0.0, 10.0))).id();
	for _ in 0..1000 {
		app1.update();
	}
	...
	let world = app2
		...
		.world_mut();
	world.spawn((RigidBody::Static, Collider::sphere(0.5), Transform::default()));
	let d2 = world.spawn((RigidBody::Dynamic, Collider::sphere(0.5), Transform::from_xyz(0.1, 0.0, 10.0))).id();
	for _ in 0..1000 {
		app2.update();
	}
